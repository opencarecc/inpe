...
// array to store chars for the log file name
char fileName[100] = {0,};
int fileNum = 0;

// array to store chars for the heading of the log file
...
void createFile() {
  ...
  sprintf(fileName, "Fall-test_indoor-%02u.txt", fileNum);
  ...
  sprintf(fileHeader, "MICROS\tX\tY\tZ\tACC ACTIVITY (0=inactivity 1=activity)\tACC STATE (1=fall 2=impact)\tALG STATE S#\tFALLING TIME\tIMPACT TIME\tINACTIVITY TIME\tFALL DETECTED\tUSER INPUT(1=YES 2=NO 3=TRIG)\r\n\r\n");
