...
#ifndef _LDISPLAYEXT_H
#define _LDISPLAYEXT_H


#include "LTask.h"


class LDisplayExtClass : public _LTaskClass 
{
public:
    LDisplayExtClass() {};
...
public:
  ...
  void draw_fill_rectangle(uint8_t ulX, uint8_t ulY, uint8_t ulWidth, uint8_t ulHeight, uint32_t FCulValue, uint32_t BorderCulValue);
  void draw_empty_rectangle(uint8_t ulX, uint8_t ulY, uint8_t ulWidth, uint8_t ulHeight, uint32_t BorderCulValue);

  /**
   *  \brief Draw fill ellips, need function draw_point to update display.
   *  
   *  \param [in] ulX1 x offset of start point, from 0 to 239
   *  \param [in] ulY1 y offset of start point, from 0 to 239
   *  \param [in] ulX2 x offset of end point, from 0 to 239
   ...
   *  \return Return Null.
   */
  void draw_fill_ellipse(uint8_t ulX, uint8_t ulY, uint8_t ulWidth, uint8_t ulHeight, uint32_t FCulValue, uint32_t BorderCulValue);
  void draw_empty_ellipse(uint8_t ulX, uint8_t ulY, uint8_t ulWidth, uint8_t ulHeight, uint32_t BorderCulValue);
  
  void draw_fill_triangle(uint8_t ulX1, uint8_t ulY1, uint8_t ulX2, uint8_t ulY2, uint8_t ulX3, uint8_t ulY3, uint32_t FCulValue, uint32_t BorderCulValue);
  void draw_empty_triangle(uint8_t ulX1, uint8_t ulY1, uint8_t ulX2, uint8_t ulY2, uint8_t ulX3, uint8_t ulY3, uint32_t BorderCulValue);

  // void draw_fill_polygon(uint8_t points[], uint8_t number_of_points, uint32_t FCulValue);
